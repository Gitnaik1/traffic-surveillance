...
const volumeData = [
  { t: "06:00", count: 320 }, { t: "07:00", count: 890 }, { t: "08:00", count: 1450 },
  { t: "09:00", count: 1120 }, { t: "10:00", count: 780 }, { t: "11:00", count: 640 },
  { t: "12:00", count: 720 }, { t: "13:00", count: 810 }, { t: "14:00", count: 700 },
  { t: "15:00", count: 760 }, { t: "16:00", count: 1050 }, { t: "17:00", count: 1380 },
  { t: "18:00", count: 1820 }, { t: "19:00", count: 1530 }, { t: "20:00", count: 980 },
  { t: "21:00", count: 540 }, { t: "22:00", count: 310 },
];

const cameraData = [
  { cam: "CAM-001", vehicles: 1840 }, { cam: "CAM-002", vehicles: 2210 },
  { cam: "CAM-003", vehicles: 2950 }, { cam: "CAM-004", vehicles: 1650 },
  { cam: "CAM-005", vehicles: 1290 }, { cam: "CAM-006", vehicles: 980 },
  { cam: "CAM-007", vehicles: 2100 }, { cam: "CAM-008", vehicles: 1760 },
];

const vehicleDistribution = [
  { name: "Cars", value: 6840 },
  { name: "2-Wheelers", value: 3210 },
  { name: "Buses", value: 890 },
  { name: "Trucks", value: 640 },
  { name: "Autos", value: 902 },
];
...
function KpiCard({ label, value, sub, color = "#2563eb" }: { label: string; value: string; sub?: string; color?: string }) {
  return (
    <div
      style={{
        background: "#141c2e",
  ...
  return (
    <div style={{ padding: "24px", overflowY: "auto", height: "100%", background: "#0b0f1a" }}>
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 20, flexWrap: "wrap" }}>
        <KpiCard label="Total Vehicles" value="12,482" sub="↑ 4.2% vs yesterday" color="#60a5fa" />
        <KpiCard label="Average Speed" value="31.4 km/h" sub="↓ 3.1 km/h vs avg" color="#22d3ee" />
        <KpiCard label="Avg Travel Time" value="15m 42s" sub="↑ 2m 10s vs avg" color="#f59e0b" />
        <KpiCard label="Congestion Level" value="Moderate" sub="Trending upward" color="#fbbf24" />
        <KpiCard label="Peak Traffic" value="18:00–19:00" sub="Highest load window" color="#a78bfa" />
      ...
      >
        <ChartCard title="Traffic Volume Over Time" span={2}>
          <ResponsiveContainer width="100%" height={180}>
            <LineChart data={volumeData}>
              ...
              <Line type="monotone" dataKey="count" stroke="#2563eb" strokeWidth={2} dot={false} name="Vehicles" />
            </LineChart>
          </ResponsiveContainer>
        </ChartCard>
        ...
        <ChartCard title="Vehicle Type Distribution">
          <ResponsiveContainer width="100%" height={180}>
            <PieChart>
              <Pie data={vehicleDistribution} dataKey="value" nameKey="name" cx="50%" cy="50%" innerRadius={45} outerRadius={70} paddingAngle={3}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 280px", gap: 14 }}>
        ...
        >
          ...
          {[
            ...
            { label: "Vehicles Today", value: "12,482", color: "#34d399" },
            { label: "Busiest Junction", value: "MG Road × Brigade", color: "#f87171" },
            { label: "Cameras Online", value: "24 / 26", color: "#34d399" },
          ].map((item) => (
            <div
              key={item.label}
              style={{
